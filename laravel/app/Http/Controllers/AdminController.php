...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.panel', compact('avisos', 'tecnicos', 'gestoras', 'especialidades'));
    }
    ...
    public function actualizar(Request $request, $id)
    {
        ...
        $aviso->update($request->only([
            'urgencia', 'fecha', 'franja', 'zona',
            'descripcion', 'direccion', 'telefono', 'estado',
        ]));

        // Notificar al técnico y a la gestora si el estado cambia
