        ...
        <ul class="navbar-nav me-auto gap-1 ms-3">
            @auth
                @if(auth()->user()->rol === 'admin')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.calendario') ? 'active' : '' }}" href="{{ route('admin.calendario') }}">
                            <i class="bi bi-calendar3 me-1"></i> Calendario
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.liquidaciones') ? 'active' : '' }}" href="{{ route('admin.liquidaciones') }}">
                            <i class="bi bi-cash-stack me-1"></i> Liquidaciones
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.tecnicos') ? 'active' : '' }}" href="{{ route('admin.tecnicos') }}">
                            <i class="bi bi-tools me-1"></i> Técnicos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('admin.servicios') ? 'active' : '' }}" href="{{ route('admin.servicios') }}">
                ...
                @if(auth()->user()->rol === 'gestora')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('gestora.panel') ? 'active' : '' }}" href="{{ route('gestora.panel') }}">
                ...
                @if(auth()->user()->rol === 'tecnico')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('tecnico.panel') ? 'active' : '' }}" href="{{ route('tecnico.panel') }}">
                ...
                @if(auth()->user()->rol === 'cliente')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('incidencias.create') ? 'active' : '' }}" href="{{ route('incidencias.create') }}">
        ...
        <ul class="navbar-nav align-items-center gap-2">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="min-width:300px;">
                    <li class="px-3 py-2 text-muted small fw-bold border-bottom">Notificaciones nuevas</li>
                    ...
                    <li>
                        <a class="dropdown-item small text-center text-secondary" href="{{ route('notificaciones.index') }}">
